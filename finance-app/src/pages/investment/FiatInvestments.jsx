...
export default function FiatInvestment() {
  const fiatInvestmentData = useLoaderData();

  const totalFiatIncome = calTotal(fiatInvestmentData);
  ...
  return (
    <div className="w-full h-auto flex flex-col justify-start item-start py-[1rem] px-[0.5rem] gap-8 ">
      ...
      <div className="w-full h-auto flex flex-col justify-start items-start gap-4">
        <DetailTitle
          detailName="Total Fiat Investment"
        ...
        <div className="w-full h-auto flex flex-col justify-start items-start gap-3 ">
          {fiatInvestmentData.map(function (data, index) {
            return (
              <List
                key={index}
